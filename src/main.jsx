...
const sakuraCards = [
  { number:'01', label:'THE STACK', title:'TOOLS + CODE', image:'./assets/sakura-tools.svg', accent:'The machinery behind the image.', text:'The technologies behind the interfaces: enough engineering to make the visual idea fast, responsive and maintainable.', items:['HTML · CSS · JavaScript','TypeScript · React · Next.js','Vite · Git · Linux · Framer Motion'], meta:'FRONTEND · SYSTEMS · MOTION' },
  { number:'02', label:'CURRENTLY EXPLORING', title:'LEARNING', image:'./assets/sakura-learning.svg', accent:'Always one layer deeper.', text:'The current focus is on cleaner systems, richer interactions and lighter experiences.', items:['Advanced React architecture','TypeScript depth and data flow','Interaction, motion and frontend performance'], meta:'STUDY · TEST · REFINE' },
  { number:'03', label:'THE PERSON BEHIND IT', title:'ABOUT ME', image:'./assets/sakura-about.svg', accent:'Less noise. More intent.', text:'I care about hierarchy, atmosphere and the small details that make a digital product feel considered.', items:['Focus — web / UI','Style — minimal / immersive','Approach — design · build · refine'], meta:'CLARITY · DETAIL · RESTRAINT' },
  { number:'04', label:'FOR CLIENTS', title:'SERVICES', image:'./assets/sakura-services.svg', accent:'From first frame to final pass.', text:'A practical set of web services for small businesses and independent brands.', items:['Custom websites','Landing pages and redesigns','Responsive UI · visual design · performance'], meta:'BUILD · REDESIGN · DELIVERY' },
  { number:'05', label:'SIDE LAB', title:'EXPERIMENTS', image:'./assets/sakura-experiments.svg', accent:'Make the interface breathe.', text:'Motion, glass, depth and small interactions built because the web becomes more interesting when it can feel cinematic.', items:['Layered photography and depth','Canvas snowfall and atmosphere','Glass surfaces and scene transitions'], meta:'MOTION · DEPTH · ATMOSPHERE' },
  { number:'06', label:'VISUAL LANGUAGE', title:'DIRECTION', image:'./assets/sakura-direction.svg', accent:'A quiet visual language.', text:'Pink sakura against black, smoked glass, editorial type and restrained motion define the visual direction.', items:['Pink sakura on black','Smoked glass surfaces','Editorial typography + restrained motion'], meta:'IMAGE · TYPE · ATMOSPHERE' },
];
