...
const sakuraCards = [
  { number:'01', label:'SAKURA / DARK', title:'BLOOM', image:'https://unsplash.com/photos/pink-cherry-blossoms-on-a-dark-background-_ao0yTpk7dQ/download?force=true&w=900&q=82', accent:'Pink against deep shadow.', lead:'A quiet study of sakura against a dark, cinematic background.', items:['Pink cherry blossoms','Dark background','Soft cinematic contrast'], meta:'SAKURA / DARK / UNSPLASH' },
  { number:'02', label:'SAKURA / DARK', title:'BRANCH', image:'https://unsplash.com/photos/pink-cherry-blossoms-bloom-on-dark-tree-branches-VxEKNJg40EA/download?force=true&w=900&q=82', accent:'Branches disappear into black.', lead:'Pink blossoms and dark branches create a restrained, graphic composition.', items:['Pink blossom detail','Dark tree branches','Minimal visual contrast'], meta:'SAKURA / BRANCH / UNSPLASH' },
  { number:'03', label:'SAKURA / DARK', title:'BOKEH', image:'https://unsplash.com/photos/pink-cherry-blossoms-on-dark-branches-with-blurred-background-Dyb6WbeVr3I/download?force=true&w=900&q=82', accent:'Soft focus. Deep background.', lead:'Delicate sakura framed by a dark, blurred atmosphere.', items:['Soft pink petals','Blurred dark background','Depth through focus'], meta:'SAKURA / BOKEH / UNSPLASH' },
  { number:'04', label:'SAKURA / DARK', title:'NIGHT', image:'https://unsplash.com/photos/cherry-blossoms-against-a-dark-night-sky-7-OyIuvY6uw/download?force=true&w=900&q=82', accent:'Sakura after dark.', lead:'Cherry blossoms set against a deep night scene.', items:['Night atmosphere','Pink blossom tones','Dark negative space'], meta:'SAKURA / NIGHT / UNSPLASH' },
  { number:'05', label:'SAKURA / DARK', title:'CINEMA', image:'https://unsplash.com/photos/delicate-pink-cherry-blossoms-bloom-on-a-dark-background-8gpqu3UigeI/download?force=true&w=900&q=82', accent:'Light finds the petals.', lead:'A cinematic close-up built around pink blossoms and deep shadows.', items:['Directional light','Pink petals','Deep shadow'], meta:'SAKURA / CINEMA / UNSPLASH' },
  { number:'06', label:'SAKURA / DARK', title:'BLACK', image:'https://unsplash.com/photos/selective-color-photography-of-white-flowers-Pi2YfVX-TMY/download?force=true&w=900&q=82', accent:'Sakura in black.', lead:'A dark botanical composition with blossoms isolated against black.', items:['Black background','Sakura detail','Graphic silhouette'], meta:'SAKURA / BLACK / UNSPLASH' },
  { number:'07', label:'SAKURA / DARK', title:'MOODY', image:'https://unsplash.com/photos/cherry-blossoms-bloom-against-a-dark-moody-background-h-ghoFr1D5s/download?force=true&w=900&q=82', accent:'Quiet, dark, floral.', lead:'A moody cherry-blossom scene with pink flowers against deep shadows.', items:['Moody dark tones','Pink flowers','Atmospheric depth'], meta:'SAKURA / MOODY / UNSPLASH' },
];
