...
const sakuraCards = [
  { number:'01', label:'THE CRAFT', title:'INTERFACE', image:'https://images.unsplash.com/photo-1777750496287-98501c4deeb4?auto=format&fit=crop&w=900&q=78', accent:'Quiet visual systems.', lead:'Interfaces built around clarity, atmosphere and intentional motion.', items:['Responsive layouts with strong hierarchy','Glass surfaces and subtle interaction','Performance-minded frontend'], meta:'WEB / UI / DIRECTION' },
  { number:'02', label:'THE STACK', title:'TOOLS + CODE', image:'https://images.unsplash.com/photo-1745042698497-39ae54d3293b?auto=format&fit=crop&w=900&q=78', accent:'Build with restraint.', lead:'A practical frontend stack for polished digital experiences.', items:['HTML · CSS · JavaScript','TypeScript · React · Next.js','Vite · Git · Linux · Framer Motion'], meta:'CODE / SYSTEMS / MOTION' },
  { number:'03', label:'CURRENTLY EXPLORING', title:'LEARNING', image:'https://images.unsplash.com/photo-1560147000-40ee5f2bd85c?auto=format&fit=crop&w=900&q=78', accent:'Always refining.', lead:'Going deeper into architecture, interaction and frontend performance.', items:['Advanced React architecture','TypeScript depth and data flow','Interaction and performance'], meta:'LEARNING / EXPERIMENTS' },
  { number:'04', label:'THE PERSON BEHIND IT', title:'ABOUT ME', image:'https://images.unsplash.com/photo-1781377654855-bc8710012d00?auto=format&fit=crop&w=900&q=78', accent:'Design · build · refine.', lead:'A minimal, immersive approach to web and interface design.', items:['Focus — web / UI','Style — minimal / immersive','Approach — design · build · refine'], meta:'ABOUT / PROCESS / STYLE' },
  { number:'05', label:'FOR CLIENTS', title:'SERVICES', image:'https://images.unsplash.com/photo-1767815690390-a750011a0256?auto=format&fit=crop&w=900&q=78', accent:'Make it clear.', lead:'Focused digital work for people and businesses that need a strong web presence.', items:['Custom websites','Landing pages and redesigns','Responsive UI · visual design · performance'], meta:'CLIENTS / WEB / UI' },
  { number:'06', label:'SIDE LAB', title:'EXPERIMENTS', image:'https://images.unsplash.com/photo-1782439870967-273dcbdfdffb?auto=format&fit=crop&w=900&q=78', accent:'Test the atmosphere.', lead:'Small experiments exploring depth, photography, glass and motion.', items:['Layered photography and depth','Canvas snowfall and atmosphere','Glass surfaces and scene transitions'], meta:'LAB / MOTION / VISUALS' },
  { number:'07', label:'VISUAL LANGUAGE', title:'DIRECTION', image:'https://images.unsplash.com/photo-1555099855-9ecf5abc5cb2?auto=format&fit=crop&w=900&q=78', accent:'Pink against black.', lead:'A visual direction built around sakura, smoked glass and editorial typography.', items:['Pink sakura on black','Smoked glass surfaces','Editorial typography + restrained motion'], meta:'ART DIRECTION / SAKURA' },
];
